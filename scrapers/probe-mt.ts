...
await page.goto("https://mission-trails-golf-course.book.teeitup.com/", { waitUntil: "domcontentloaded", timeout: 25_000 });
await page.waitForTimeout(8000);
console.log("Mission Trails — facilityId:", seen.facilityId, "alias:", seen.alias);
await ctx.close();
await closeBrowser();
