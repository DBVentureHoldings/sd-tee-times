...
await page.goto("https://the-vineyard-at-escondido.book.teeitup.com/", { waitUntil: "domcontentloaded", timeout: 25_000 });
await page.waitForTimeout(8000);
console.log("Vineyard TeeItUp — facilityId:", seen.facilityId, "  alias:", seen.alias);
